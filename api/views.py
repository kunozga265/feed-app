...
def getData(request):
    ...
    m = LpVariable(name="Urea (N)", lowBound=0, upBound=0 if getConcentrateItem(12, 'cost') > 0 else 0)
    ...
    q = LpVariable(name="MCP", lowBound=0, upBound=0 if getConcentrateItem(16, 'cost') > 0 else 0)
    ...
    t = LpVariable(name="Water", lowBound=0, upBound=0 if getConcentrateItem(19, 'cost') > 0 else 0)
